      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-20 mb-24">
          ...
          <div>
            ...
            <ul className="space-y-6 text-stone-400 dark:text-stone-300 text-sm font-light">
              <li className="flex flex-col gap-1">
                 <span className="text-stone-300 dark:text-stone-200 font-bold">Delhi Office</span>
                 Coordinating Center, New Delhi
              </li>
              <li className="flex flex-col gap-1">
                 <span className="text-stone-300 dark:text-stone-200 font-bold">Field HQ</span>
                 Handloom Center, NE India
              </li>
              <li className="flex flex-col gap-1">
                 <span className="text-stone-300 dark:text-stone-200 font-bold">Digital</span>
          ...
          <div>
            ...
            <ul className="space-y-6 text-stone-400 dark:text-stone-300 text-sm font-light">
              <li className="hover:text-stone-200 dark:hover:text-stone-100 transition-colors cursor-pointer">Annual Reports 2024</li>
              <li className="hover:text-stone-200 dark:hover:text-stone-100 transition-colors cursor-pointer">80(G) Certification</li>
              <li className="hover:text-stone-200 dark:hover:text-stone-100 transition-colors cursor-pointer">Artisan Registry</li>
              <li className="hover:text-stone-200 dark:hover:text-stone-100 transition-colors cursor-pointer">Legal Successes</li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-12 border-t border-stone-900/50 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-10">
             <span className="text-stone-500 dark:text-stone-400 text-[9px] uppercase tracking-[0.4em] hover:text-stone-300 dark:hover:text-stone-200 cursor-pointer transition-colors">Privacy</span>
             <span className="text-stone-500 dark:text-stone-400 text-[9px] uppercase tracking-[0.4em] hover:text-stone-300 dark:hover:text-stone-200 cursor-pointer transition-colors">Security</span>
             <span className="text-stone-500 dark:text-stone-400 text-[9px] uppercase tracking-[0.4em] hover:text-stone-300 dark:hover:text-stone-200 cursor-pointer transition-colors">Tax Docs</span>
          </div>
        </div>
      </div>
    </footer>
