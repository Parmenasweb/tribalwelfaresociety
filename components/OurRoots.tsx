  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
      <div className="space-y-10 reveal reveal-up">
        ...
        <div className="flex gap-12 pt-6 border-t border-stone-100">
          <div>
            <div className="serif text-5xl text-terracotta font-bold mb-2">30+</div>
            <div className="text-[10px] uppercase tracking-widest text-stone-400 font-bold">Years of Resilience</div>
          </div>
          <div>
            <div className="serif text-5xl text-earthy-green font-bold mb-2">1993</div>
            <div className="text-[10px] uppercase tracking-widest text-stone-400 font-bold">Foundation Year</div>
          </div>
        </div>
      </div>
      ...
      <div className="relative reveal reveal-up" style={{ transitionDelay: '0.3s' }}>
        ...
        <div className="absolute -bottom-6 -left-6 bg-white p-8 shadow-xl max-w-[260px] border border-stone-100">
          <p className="serif text-stone-900 italic text-xl mb-2">Dignity in Every Thread</p>
          <p className="text-[10px] uppercase tracking-widest text-stone-500 font-bold leading-relaxed">Preserving artisanal heritage for the next generation.</p>
        </div>
      </div>
    </div>
  );
